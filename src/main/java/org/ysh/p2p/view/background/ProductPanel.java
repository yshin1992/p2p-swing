...
public class ProductPanel extends JPanel {
		...
		menuTree.addTreeSelectionListener(new TreeSelectionListener() {
			...
			public void valueChanged(TreeSelectionEvent e) {
				...
				if(selectedNode.isLeaf()){
					...
					if("项目申请".equals(selectedNode.getUserObject())){
						pane.setRightComponent(new ProductApplyPanel());
					}
				}
	...
	public ProductPanel(){
		...
		pane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT,menutreePane,new JScrollPane());
